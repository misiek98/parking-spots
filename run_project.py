...
video = cv2.VideoCapture(
    "/home/misiek/Pulpit/python/videoplayback.mp4")

# lines_yolo_model = YoloModel("path_to_model")
# cars_yolo_model = YoloModel("path_to_model")
...
while video.isOpened():
    ...
    # img = frame.copy()
    img = cv2.imread("/home/misiek/Pulpit/python/parking_spots/data/file.bmp")
